...
local startBaseALeftSwitchId = getFieldInfo("sh").id  -- start race when this switch is > 1024
local startBaseARightSwitchId = getFieldInfo("si").id  -- start race when this switch is > 1024
